...
class RosaRecipeTests(unittest.TestCase):
    ...
    def test_online_v2_sparse_sharded_recipe_applies_expected_defaults(self):
        parser = rosa_mod.build_arg_parser()
        args = parser.parse_args(
            [
                "--data_path",
        ...
        self.assertTrue(recipe_meta["applied"])
        self.assertEqual(args.rosa_recipe, "online_v2_sparse_sharded")
        self.assertEqual(args.rosa_value_mode, "per_layer")
        self.assertTrue(args.rosa_sparse_value_training)
        self.assertEqual(args.rosa_value_shards, 4)
    ...
    def test_recipe_registry_lists_online_v1(self):
        ...
        self.assertIn("online_v2_sparse_sharded", names)
